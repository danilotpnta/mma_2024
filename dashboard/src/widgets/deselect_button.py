from dash import html, dcc, Input, Output, State, callback, no_update, ALL, callback_context
...
def deselect_all(n_clicks, radio_button_value, _):
    ...
    if n_clicks is None:
        ...
        return fig_2d, fig_3d, track_info_widget, list(hist_dict.values()), filter_widget