...
def create_help_popup():
    ...
    return dbc.Modal(
        [
            ...
            dbc.ModalBody(
                "With this tool you can explore the CUB-200-2011 through a 2D UMAP or t-SNE projection of the CLIP embeddings of the bird images in the dataset. "
            ),
            dbc.ModalBody(
                "Use the scatterplot to select instances of bird images. "
            ...
            dbc.ModalBody(
                "Use the table to select bird species. The table rows can be filtered by clicking the hamburgers on the table hearder. "
            ...
            dbc.ModalBody(
                f"Use the widgets in the tabs to explore the data. The gallery shows you a sample of up to {config.IMAGE_GALLERY_SIZE} images. "
